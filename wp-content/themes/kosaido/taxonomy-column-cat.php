<?php
error_reporting(0);
$column_cat_exist = taxonomy_exists( 'column-cat' );
$column_term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
$column_taxonomy_name = $column_term->name; // will show the name
...
$term_obj_list = get_the_terms( $post->ID, 'column-cat' );
$list_category_column = get_the_terms($post->ID, 'column-cat' );
get_header();
...
$no_post_in_cate = array(
    'ja' => 'このカテゴリーには記事がありません。',
...
<main class="clearfix">
        ...
        <div id="content" class="clearfix">
            <div id="top_info">
                <div class="inner">
                    <h2><?php echo $term_obj_list[0]->name; ?></h2>
                </div>
            </div>
            <div id="topic_path">
                        ...
                        <div class="column_left">
                            <div class="column_list">
                                <?php if (have_posts()) : ?>
                                    ...
                                    <?php endwhile; ?>
                                <?php else : ?>
                                    <p><?php echo $no_post_in_cate[$currlang] ?></p>
                                <?php endif; ?>
                            </div>
